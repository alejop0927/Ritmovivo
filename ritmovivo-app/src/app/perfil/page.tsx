...
export default function PerfilPage() {
  ...
  useEffect(() => {
    if (user) {
      reset({ nombre: user.nombre, apellido: user.apellido, telefono: user.telefono });
    }
        ...
        <Card>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <Badge label={user?.rol || ""} variant="purple" />
            </div>
          </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {ins.horario.fecha} · {ins.horario.horaInicio}
                    </p>
                  </div>
                  <Badge
                    label={ins.estado}
                    variant={estadoColor[ins.estado] || "gray"}
                  />
                </div>
              ))}
            </div>
